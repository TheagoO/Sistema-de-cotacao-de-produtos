...
public class PedidoCotacaoController {
	...
	public String lancarCotacao() {
		...
		try {
			...
			fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "SUCESSO", "Cota��o lan�ada!"));
			return "SUCESSO";
		} catch (Exception e) {
			fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "ERRO", "Erro ao lan�ar cota��o"));
			e.printStackTrace();
		}
		return null;
	}
